                ...
                <div class="hero__categories">
                    ...
                    <ul>
                        @foreach ($productCategories as $productCategory)
                            @if ($productCategory->getProducts->count()>0)
        ...
        <div class="row featured__filter">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                ...
                <div class="featured__item">
                    ...
                    @endphp
                    <div class="featured__item__pic set-bg" data-setbg="{{ asset('image'.'/'.$image) }}">
...
@endsection
@section('addproducttocart-script')
   ...
   $('.add-to-cart1').on('click',function(){
    ...
    $.ajax({
            ...
            success:function(data){
                ...
                swal("Chúc mừng!", "Thêm giỏ hàng thành công!", "success");
